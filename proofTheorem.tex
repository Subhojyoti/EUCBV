...
\begin{align*}
 ...
 &\Rightarrow \rho m \log(2) \geq 2\log(\frac{T}{K}) - 2m\log( 2) \text{ , as $\psi=\dfrac{T}{K^2}$ }\\
 &\Rightarrow 2.5 m \log(2) + 2\log(K) \geq 2\log(T) \text{ , as $\rho=\dfrac{1}{2}$}\\
 &\Rightarrow 1.25 \log(2) \log_2(\dfrac{T}{e}) + 2\log(K) \geq 2\log(T) \text{ , as $m\leq \dfrac{1}{2} \log_2(\dfrac{T}{e}) $ }\\
 &\Rightarrow \dfrac{1.25 \log (2) \log (\dfrac{T}{e})}{\log(2)} + 2\log(K) \geq 2\log(T)\\
