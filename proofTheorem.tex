...
If $T\geq 81K^{2.7}$, $\psi=\dfrac{T}{81 K^2}$, $\rho=\dfrac{1}{2}$ and $m\leq \dfrac{1}{2} \log_2(\dfrac{T}{e}) $, then $\dfrac{\rho m \log(2)}{\log(\psi T) - 2m\log( 2)} \leq 1$. 
\end{lemma}
...
% or $\bigg(\dfrac{2}{(\psi T\epsilon_{m_{i}}^{2})^{y}}\bigg)$ where $y=\dfrac{\rho +\frac{1}{2}}{2}$.
