...
\hline
EUCBV		& $O\left( \dfrac{K\sigma_{\max}^{2}\log (T\Delta^2 /K)}{\Delta}\right)$ & $O\left(\sigma_{\max}^{2}\sqrt{KT}\right)$\\
UCB1        & $O\left( \dfrac{K\log T}{\Delta} \right)$ & $O\left(\sqrt{KT\log T}\right)$ \\%\midrule
UCBV        & $O\left( \dfrac{K\sigma_{\max}^{2}\log T}{\Delta} \right)$ & $O\left(\sigma_{\max}^{2}\sqrt{KT\log T}\right)$ \\
