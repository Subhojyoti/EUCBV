...
The proofs of lemmas \ref{proofTheorem:Lemma:1} - \ref{proofTheorem:Lemma:7} can be found in Appendix ~\ref{App:Lemma:1}, ~\ref{App:Lemma:2}, ~\ref{App:Lemma:3}, ~\ref{App:Lemma:4}, ~\ref{App:Lemma:5}, ~\ref{App:Lemma:6} and ~\ref{App:Lemma:7} respectively.
...
We obtain $(a)$ by substituting the value of $\psi$, $(b)$ from Lemma \ref{proofTheorem:Lemma:6} and $(c)$ from Lemma \ref{proofTheorem:Lemma:7}.\\
